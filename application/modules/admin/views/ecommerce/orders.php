            ...
            <table class="table table-condensed table-bordered table-striped">
                ...
                <tbody>
                    ...
                    foreach ($orders as $tr) {
                        ...
                        if ($tr['confirmed'] == 0) {
                            $class = 'bg-warning';
                            $type = 'Not Yet Confirmed';
                        }
                        if ($tr['processed'] == 3) {
                            $class = 'bg-primary';
                            $type = 'On-going Delivery';
                        }
                          if ($tr['processed'] == 4) {
                            $class = 'bg-success';
                            $type = 'Delivered';
                        ...
                        <tr>
                            ...
                            <td class="<?= $class ?> text-center" data-action-id="<?= $tr['id'] ?>">
                                ...
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 3)" class="btn btn-primary btn-xs">On-going Delivery</a></div>
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 4)" class="btn btn-success btn-xs">Delivered</a></div>
                                <?php } ?>
