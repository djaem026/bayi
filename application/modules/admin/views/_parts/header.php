        ...
        <div id="wrapper">
            <div id="content">
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div id="navbar" class="collapse navbar-collapse bg-success">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="<?= base_url() ?>" target="_blank"><i class="glyphicon glyphicon-star"></i> Go To Shop</a></li>
                                <li>
                ...
                <div class="container-fluid ">
                    <div class="row ">
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side" style="background-color: #ecf0f1;">
                                <div class="show-menu ">
