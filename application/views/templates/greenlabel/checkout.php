                ...
                <div class="col-sm-6 left-side">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input id="emailAddressInput" value="<?= $userInfo['email'] ?>" class="form-control" name="email" value="<?= htmlspecialchars(@$_POST['email']) ?>" type="text" placeholder="<?= lang('email_address') ?>">
                        </div>
                        <div class="form-group col-sm-6">
                            <label for="phoneInput"><?= lang('phone') ?> (<sup><?= lang('requires') ?></sup>)</label>
                            <input id="phoneInput" class="form-control" value="<?= $userInfo['phone'] ?>" name="phone" value="<?= htmlspecialchars(@$_POST['phone']) ?>" type="text" placeholder="<?= lang('phone') ?>">
                        </div>
                        ...
                        <table class="table table-bordered table-products">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="final-amount"><?= (int)$shippingAmount + $cartItems['finalSum'] ?></span><?= CURRENCY ?>
                                    </td>
                                </tr>
                                <?php } ?>
