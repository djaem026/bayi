                                ...
                                <tr>
                                    ...
                                    <td><?php 
                                        if($order['processed'] == 1){ ?>
                                              <span class="badge badge-secondary" style= "background-color:green">Order Confirmed</span>
                                            
                                       <?php }
                                       
                                         if($order['processed'] == 2){ ?>
                                              <span class="badge badge-secondary" style= "background-color:orange">Order Not Processed</span>
                                            
                                       <?php }
                                          if($order['processed'] == 0){ ?>
                                              <span class="badge badge-secondary" style= "background-color:red">Order Rejected</span>
                                            
                                       <?php }
                                        if($order['processed'] == 3){ ?>
                                              <span class="badge badge-secondary" style= "background-color:blue">On-going Delivery</span>
                                            
                                       <?php }
                                           if($order['processed'] == 4){ ?>
                                              <span class="badge badge-secondary" style= "background-color:green">Successfully Delivered</span>
